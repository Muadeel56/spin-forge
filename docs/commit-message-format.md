...
This document outlines the standard commit message format for the TailorX project.
...
When creating a commit, use this format to ensure consistency and proper issue tracking.
